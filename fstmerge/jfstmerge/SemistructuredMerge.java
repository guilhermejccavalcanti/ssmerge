...
public final class SemistructuredMerge {
	 ...
	 */
	private static String markNodesContributions(String bodyA, String bodyB, boolean firstPass, int indexA, int indexB) { //#PAREI AQUI, indexB é necessário? pra que serve index
